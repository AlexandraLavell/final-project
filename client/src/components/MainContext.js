...
export const MainContextProvider = ({children}) => {
    ...
    const [employeeList, setEmployeeList] = useState([{_id:"employee-1", name:"Ali Lavell", projects:["project-1"]}    
    , {_id: "employee-2"}]); // list of all employees -- will be on the database
